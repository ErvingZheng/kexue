    ...
    >
      ...
      >
        <div>
          ...
          <div v-if="equipmentType === 'pc'" class="page">
      ...
      >
        ...
        <div v-if="mode === 'biaodian' || old_mode != ''" class="del-box">
      ...
      >
        ...
        <span v-else class="key blue" @[keyEvent]="cn_change('cn')">
        ...
        <span class="key space" @[keyEvent]="clickKey($event, ' ', true)"
          >空格</span
        >
        <span class="key blue" @[keyEvent]="() => (mode = 'biaodian')"
          >符号</span
        >
        <span class="key blue" @[keyEvent]="() => (mode = 'num')">数字</span>
      </div>
      <!--选词板-->
